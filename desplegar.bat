...
REM
REM  Enlace bueno: https://morales.creskio.com
REM ============================================================
cd /d "E:\Escritorio\DEMOS TALLERES\Neumaticos Morales Zaidin"

echo.
echo  Publicando Morales Zaidin
echo  --------------------------------------------
echo.
...
echo     https://morales.creskio.com
echo.
